...
class PropertyValuation(Base):
    ...
    Tracks estimated value, confidence, and the provider used.
    """
    ...
    provider = Column(Enum(ValuationProvider), default=ValuationProvider.INTERNAL_ALGO)
    
    # Optional link to a generated PDF report
