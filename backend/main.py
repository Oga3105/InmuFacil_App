...
from backend.src.routes import notifications_email
from backend.src.routes import market_price, price_validator, legal_guides
from backend.src.routes import ai_generate
